export default function PrimaryButtonDark ({ children }){

    return (

        <button className="relative items-center justify-start inline-block px-6 py-3 lg:px-8 lg:py-4 lg:text-lg overflow-hidden font-medium font-sora rounded-full group">
            ...
            <span className="relative w-full text-black transition-colors duration-200 ease-in-out group-hover:text-white">{ children }</span>
